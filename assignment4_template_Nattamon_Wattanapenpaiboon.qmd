...
Across Europe, divorces with reported duration information make up only a small share of total cases in any single marriage‑length category. Very early divorces (0–1 years) are the least common, accounting for only about 2–3% of reported cases in the average country. The share increases gradually with marriage length, rising to around 6% for 1–2 and 3–4 years, and reaching roughly 7% for 5–9 years. The highest share appears in the 10+ years category, at about 11% of reported cases. These values reflect the relative distribution among divorces that include duration data, not all divorces, since many countries report only a subset of cases with duration information. Even so, the pattern shows that mid‑ and longer‑duration marriages are more likely to end in divorce than very early ones.
